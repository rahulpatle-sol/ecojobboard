...
export default function Roadmap() {
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-b from-amber-50 via-green-100 to-yellow-50 p-8 md:p-16">
      {/* Header */}
      <div className="mb-24">
        <h1 className="text-5xl md:text-6xl font-black text-gray-900 mb-2 leading-tight">
          Become the <br /> Top 1% Talent
        </h1>
        <p className="text-amber-700 text-lg font-medium">Industry-ready skilled talent roadmap</p>
      </div>

      {/* Roadmap Container */}
      <div className="relative w-full overflow-x-auto pb-32">
        <div className="min-w-max px-8">
          ...
          <div className="flex gap-16 relative z-10">
            {steps.map((step, index) => (
              <div key={index} className="flex flex-col items-center flex-shrink-0 w-56">
                {/* Dot */}
                <div className="w-10 h-10 bg-amber-200 rounded-full border-4 border-amber-300 shadow-xl mb-12 relative z-20 hover:scale-110 transition-transform duration-300 ease-out"></div>
